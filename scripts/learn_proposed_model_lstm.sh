...
~/Miacis/scripts/vsEdax.py --game_num=1000 --level=1 --search_limit=0 --proposed_model_lstm --use_readout_only
~/Miacis/scripts/vsEdax.py --game_num=1000 --level=1 --search_limit=10 --proposed_model_lstm --use_readout_only
