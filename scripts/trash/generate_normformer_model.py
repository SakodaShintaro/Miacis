...
class TransformerBlock(nn.Module):
    def __init__(self, d_model, nhead):
        ...
        layer_norm_eps = 1e-5
        self.attn_norm1 = nn.LayerNorm(d_model, eps=layer_norm_eps)
        self.attn_norm2 = nn.LayerNorm(d_model, eps=layer_norm_eps)
        self.ffn_norm1 = nn.LayerNorm(d_model, eps=layer_norm_eps)
        self.ffn_norm2 = nn.LayerNorm(dim_feedforward, eps=layer_norm_eps)
