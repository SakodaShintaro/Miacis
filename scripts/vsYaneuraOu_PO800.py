...
# パラメータを探索
for temperature_x1000 in range(0, 10, 1):
    # Miacisを準備
    server.engines[0].set_engine_options({"random_turn": 320,
                                          "temperature_x1000": temperature_x1000,
    ...
    for i in range(args.game_num):
        ...
        result_str = f"temperature_x1000={temperature_x1000:2d} {total_num[WIN]:3d}勝 {total_num[DRAW]:3d}引き分け {total_num[LOSE]:3d}敗 勝率 {100 * winning_rate:4.1f}% 相対レート {elo_rate:6.1f}"
