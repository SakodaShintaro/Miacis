...
def main(*argv):
    ...
    if args.optimizer[-1] != ')':
        args.optimizer += '()'
    optimizer = eval('optim.' + args.optimizer.replace('(', '(model.parameters(),lr=args.lr,' +
    ...
    if args.use_swa:
        ...
        def ema_avg(averaged_model_parameter, model_parameter, num_averaged): return ema_a * averaged_model_parameter + ema_b * model_parameter
