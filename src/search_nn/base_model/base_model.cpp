...
torch::Tensor BaseModel::policyLoss(const torch::Tensor& policy_logit, const torch::Tensor& policy_teacher) {
...
torch::Tensor BaseModel::entropyLoss(const torch::Tensor& policy_logit) {
