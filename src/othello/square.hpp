#ifndef MIACIS_OTHELLO_SQUARE_HPP
#define MIACIS_OTHELLO_SQUARE_HPP
...
inline static Dir oppositeDir(const Dir d) { return static_cast<Dir>(-d); }
...
inline static Square operator+(Square sq, Dir diff) { return static_cast<Square>(static_cast<int>(sq) + static_cast<int>(diff)); }

inline static int operator<<(Square sq, int shift) { return static_cast<int>(static_cast<int>(sq) << shift); }
