...
void NNTensorRT::load(const std::string& model_path, int64_t gpu_id, int64_t opt_batch_size,
...
std::pair<std::vector<PolicyType>, std::vector<ValueType>> NNTensorRT::policyAndValueBatch(const std::vector<float>& inputs) {
