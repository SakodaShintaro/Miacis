...
/// See https://pytorch.org/docs/master/nn.html#proposed_model_transformer-layers to learn
...
public:
    ...
    Tensor forward(Tensor tgt, const Tensor& memory, const Tensor& tgt_mask = {}, const Tensor& memory_mask = {},
